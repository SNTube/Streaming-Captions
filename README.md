...
- 功能包括界面宽度、字号大小、优先语言、VAC模式(VAC专用模式)、标点恢复、文本居中与靠左、锁定界面(带鼠标穿透)、隐藏界面、隐藏按钮、热词增强、快捷键、复制当前显示文本、更改字体、移动至光标、背景图片及设置。
...
2. `核心设置` 分栏中，找到 `文本输入` ，开启 `HOOK` 开关。`HOOK设置` 下，`默认设置` 的 `代码页` 选 `UTF8_(CP65001)` 。
